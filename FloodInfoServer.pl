...
sub process_one_req {
	...
	print($Inondesfh "<Style id=\"My_Style\"><IconStyle> <Icon> <href>\icons\\$isFlooded.png</href> </Icon></IconStyle></Style><Placemark><name>$timestamp</name><styleUrl>#My_Style</styleUrl><Point><coordinates>$mLongitude,$mLatitude</coordinates></Point></Placemark>\n");
	print($Cavesfh "<Style id=\"My_Style\"><IconStyle> <Icon> <href>\icons\\$isCaveFlooded.png</href> </Icon></IconStyle></Style><Placemark><name>$timestamp</name><styleUrl>#My_Style</styleUrl><Point><coordinates>$mLongitude,$mLatitude</coordinates></Point></Placemark>\n");
	print($Telephonefh "<Style id=\"My_Style\"><IconStyle> <Icon> <href>\icons\\$hasTelephone.png</href> </Icon></IconStyle></Style><Placemark><name>$timestamp</name><styleUrl>#My_Style</styleUrl><Point><coordinates>$mLongitude,$mLatitude</coordinates></Point></Placemark>\n");
	print($Powerfh "<Style id=\"My_Style\"><IconStyle> <Icon> <href>\icons\\$hasPower.png</href> </Icon></IconStyle></Style><Placemark><name>$timestamp</name><styleUrl>#My_Style</styleUrl><Point><coordinates>$mLongitude,$mLatitude</coordinates></Point></Placemark>\n");
	print($Waterfh "<Style id=\"My_Style\"><IconStyle> <Icon> <href>\icons\\$hasWater.png</href> </Icon></IconStyle></Style><Placemark><name>$timestamp</name><styleUrl>#My_Style</styleUrl><Point><coordinates>$mLongitude,$mLatitude</coordinates></Point></Placemark>\n");
	print($Gazfh "<Style id=\"My_Style\"><IconStyle> <Icon> <href>\icons\\$hasGaz.png</href> </Icon></IconStyle></Style><Placemark><name>$timestamp</name><styleUrl>#My_Style</styleUrl><Point><coordinates>$mLongitude,$mLatitude</coordinates></Point></Placemark>\n");
	print($Drainagefh "<Style id=\"My_Style\"><IconStyle> <Icon> <href>\icons\\$hasDrainage.png</href> </Icon></IconStyle></Style><Placemark><name>$timestamp</name><styleUrl>#My_Style</styleUrl><Point><coordinates>$mLongitude,$mLatitude</coordinates></Point></Placemark>\n");
	print($Impactedfh "<Style id=\"My_Style\"><IconStyle> <Icon> <href>\icons\\$numImpacted.png</href> </Icon></IconStyle></Style><Placemark><name>$timestamp</name><styleUrl>#My_Style</styleUrl><Point><coordinates>$mLongitude,$mLatitude</coordinates></Point></Placemark>\n");
